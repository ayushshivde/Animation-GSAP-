...
//       scrollTrigger: {
//         trigger: ".section-two-product-features", // jahan image scroll ke baad aani chahiye
//         start: "top 100%", // kab start ho
//         end: "top 0%", // kab end ho
//         scrub: 1,
//       },
//     });
...
const headingRefs = useRef([]);
  ...
  const [selectedColorName, setSelectedColorName] = useState(
   ...
   useEffect(() => {
    const scrollY = lenis.scrollTo({
      top: 0,
      behavior: 'auto', //
    });
     
      console.log("entering productingo page scroll position:", scrollY);
  ...
  useEffect(() => {
    return () => {
     const scrollY = lenis.scrollTo({
      ...
      console.log("Leaving productinfo at scroll position:", scrollY);
    };
  }, []);
