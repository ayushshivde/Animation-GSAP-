...
//               <div className="left">
//                 <Link to={"/"} className="Link" onClick={()=>handleMenuOpening()} >HOME</Link>
//                 <Link to={"/new"} className="Link" onClick={()=>handleMenuOpening()}>NOTHING NEW</Link>
//                 <Link to={"/shop"} className="Link" onClick={()=>handleMenuOpening()}>SHOP</Link>
//                 <Link to={"/about"} className="Link" onClick={()=>handleMenuOpening()}>ABOUT</Link>
//               </div>
...
//                     <Link to={'/shop/productinfo/phone3'} className="phone-link">{"NOTHING PHONE (3)"} </Link>
//                     <Link  to={'/shop/productinfo/phone3apro'} className="phone-link">
//                       {"NOTHING PHONE 3A PRO"}{" "}
//                     </Link>
//                     <Link  to={'/shop/productinfo/phone3a'} className="phone-link">{"NOTHING PHONE 3A "} </Link>
//                     <Link to={'/shop/productinfo/phone2aplus'} className="phone-link">
//                       {"NOTHING PHONE 2A PLUS"}{" "}
//                     </Link>
//                     <Link to={'/shop/productinfo/phone2a'} className="phone-link">{"NOTHING PHONE 2A "} </Link>
//                   </div>
...
//                     <Link  to={'/shop/productinfo/headphone1white'} className="audio-link">{"NOTHING HEADPHONE 1"} </Link>

//                     <Link to={'/shop/productinfo/earwhite'} className="audio-link">{"NOTHING EAR "} </Link>
//                     <Link to={'/shop/productinfo/cmfbudspro2'}  className="audio-link">{"CMF BUDS PRO 2"} </Link>
//                     <Link to={'/shop/productinfo/cmfbuds2plus'}  className="audio-link">
//                       {"CMF BUDS 2 PLUS"}
//                     </Link>
//                     <Link  to={'/shop/productinfo/earopen'} className="audio-link">{"NOTHING EAR OPEN "} </Link>
//                   </div>
//                 </div>
//               </div>
...
//                 <Link   ref={addpageRefs}  style={{opacity:"0"}}to={"/new"} className="Link" onClick={() => handleMenuOpening()}>NOTHING NEW</Link>
//                 <Link  ref={addpageRefs} style={{opacity:"0"}}to={"/shop"} className="Link" onClick={() => handleMenuOpening()}>SHOP</Link>
//                 <Link   ref={addpageRefs} style={{opacity:"0"}} to={"/about"} className="Link" onClick={() => handleMenuOpening()}>ABOUT</Link>
//               </div>
...
//                   <div className="phone-names-div">
//                     <Link  to={'/shop/productinfo/phone3'}className="phone-link">NOTHING PHONE (3)</Link>
//                     <Link to={'/shop/productinfo/phone3apro'} className="phone-link">NOTHING PHONE 3A PRO</Link>
//                     <Link to={'/shop/productinfo/phone3a'} className="phone-link">NOTHING PHONE 3A</Link>
//                     <Link to={'/shop/productinfo/phone2aplus'} className="phone-link">NOTHING PHONE 2A PLUS</Link>
//                     <Link to={'/shop/productinfo/phone2a'} className="phone-link">NOTHING PHONE 2A</Link>
//                   </div>
...
//                     <Link to={'/shop/productinfo/earwhite'} className="audio-link">NOTHING EAR</Link>
//                     <Link to={'/shop/productinfo/cmfbudspro2'} className="audio-link">CMF BUDS PRO 2</Link>
//                     <Link to={'/shop/productinfo/cmfbuds2plus'} className="audio-link">CMF BUDS 2 PLUS</Link>
//                     <Link to={'/shop/productinfo/earopen'} className="audio-link">NOTHING EAR OPEN</Link>
//                   </div>
//                 </div>
//               </div>
